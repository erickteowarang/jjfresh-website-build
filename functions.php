...
$theme_settings = [
   ...
   * Theme textdomain
   */
  'textdomain' => 'jjfresh-website',

  /**
   * Menu locations
   */
  'menu_locations' => [
    'primary' => __( 'Primary Menu', 'jjfresh-website' ),
  ],
   ...
   * https://github.com/digitoimistodude/jjfresh-website#custom-taxonomies
   */
  'taxonomies' => [
    /**
    'your-taxonomy' => [
   ...
   *
   * See the instructions:
   * https://github.com/digitoimistodude/jjfresh-website#custom-post-types
   */
