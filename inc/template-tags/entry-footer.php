...
function entry_footer() {
  ...
  if ( ! is_single() && ! post_password_required() && ( comments_open() || get_comments_number() ) ) {
    ...
    comments_popup_link( sprintf( wp_kses( __( 'Leave a comment<span class="screen-reader-text"> on %s</span>', 'jjfresh-website' ), array( 'span' => array( 'class' => array() ) ) ), get_the_title() ) );
    echo '</span>';
  }
}
